...
if(keyboard_check(ord("1")) && player_cooldown < 1){
	instance_create_layer(obj_tower_player.x, obj_tower_player.y, "Instances", obj_a_sworld_1);
	// 100, 500 là tọa độ bên trái màn hình	
	player_cooldown = spawn_cooldown
}

if(keyboard_check(ord("2")) && enemy_cooldown < 1){
	instance_create_layer(obj_tower_enemy.x, obj_tower_enemy.y, "Instances", obj_e_sworld_1);
